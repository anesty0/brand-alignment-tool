  ...
  return (
    <section id="top" className="relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        {/* scrim is stronger below lg, where the longer copy spans the full width and would otherwise sit on the skiers */}
        <div className="absolute inset-0 bg-gradient-to-r from-background/90 via-background/65 to-background/25 lg:from-background/80 lg:via-background/25 lg:to-transparent" />
      </div>
      ...
      <div className="relative container-x pt-8 md:pt-14 lg:pt-10 pb-16 md:pb-24 lg:pb-16 xl:pb-20">
        <div className="max-w-2xl">
          ...
          <p className="mt-3 text-base md:text-lg text-foreground/80 max-w-md leading-snug">
            {t("hero.tagline")}
          </p>

          <h2 className="mt-4 text-orange font-extrabold tracking-tight leading-[0.95] text-2xl sm:text-3xl md:text-4xl lg:text-5xl">
            {t("brand.hero")}
          </h2>

          <p className="mt-3 text-lg md:text-xl font-bold text-navy tracking-tight">
            {t("hero.heading")}
          </p>
          ...
          <p className="mt-4 text-sm md:text-base text-foreground/75 max-w-xl leading-relaxed whitespace-pre-line">
            {t("hero.sub")}
          </p>
