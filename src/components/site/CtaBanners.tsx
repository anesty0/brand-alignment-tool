        ...
        <div className="grid lg:grid-cols-[1fr_1fr_0.8fr] gap-6">
          <div className="rounded-2xl bg-orange-soft p-6 md:p-8 flex gap-5 items-center">
            ...
            <div className="flex-1">
              ...
              <a href="/sponsorship.pdf" target="_blank" rel="noopener noreferrer" className="mt-4 inline-flex items-center gap-2 rounded-md bg-primary text-primary-foreground px-5 py-2.5 text-xs font-semibold tracking-wider hover:brightness-110 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-navy focus-visible:ring-offset-2">
                <FileText size={14} /> {t("cta.partner.btn")}
              </a>
            </div>
          </div>

          <div className="rounded-2xl bg-secondary p-6 md:p-8 flex gap-5 items-center">
            <Calendar className="text-navy shrink-0" size={48} strokeWidth={1.5} />
            <div className="flex-1">
              <h4 className="text-base md:text-lg font-extrabold tracking-wide text-navy whitespace-pre-line">{t("cta.speaker.t")}</h4>
              <p className="mt-2 text-sm text-muted-foreground">{t("cta.speaker.b")}</p>
              <a href="/alps-connect.pdf" target="_blank" rel="noopener noreferrer" className="mt-4 inline-flex items-center gap-2 rounded-md bg-navy text-white px-5 py-2.5 text-xs font-semibold tracking-wider hover:brightness-125 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange focus-visible:ring-offset-2">
                <FileText size={14} /> {t("cta.speaker.btn")}
              </a>
            </div>
          </div>
