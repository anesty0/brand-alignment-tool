          ...
          {hotels.map((h) => (
            ...
            >
              ...
              <div className="p-5 pb-4 flex-1 flex flex-col">
                <h4 className="text-sm lg:text-[15px] xl:text-base 2xl:text-lg font-bold text-navy leading-tight min-h-[2em]">{h.name}</h4>
                <div className="mt-0 flex items-baseline gap-1.5">
