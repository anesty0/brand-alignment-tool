...
const ru: Dict = {
  ...
  // About
  "about.subtitle": "Клуб русскоговорящих предпринимателей Европы.",
  "about.event": "SKI OPENING",
  "about.heading": "Зимняя встреча клуба в Альпах.",
  "about.body": "В Зёльдене, на одном из лучших горнолыжных курортов Альп, в обстановке off the record соберутся русскоговорящие предприниматели из разных стран.\n\nПять дней в кругу людей, с которыми совпадает ваш код. Не нужно объяснять базовые вещи — мы говорим, думаем и смеёмся на одном языке.",
  "about.f1.t": "ФОРМАТ",
  "about.f1.h": "Формируем деловую среду.",
  "about.f1.b": "Ski Opening - это пять дней в Альпах, где отдых и деловое общение дополняют друг друга. Днем - горы и катание. Вечером - деловая программа, встречи и совместные ужины. Такой формат помогает познакомиться и считать код друг друга.",
  "about.f2.t": "УЧАСТНИКИ",
  "about.f2.h": "Такие же, как вы.",
  "about.f2.b": "Предприниматели, инвесторы и эксперты из разных стран Европы. Кто-то живет здесь уже много лет, кто-то только начинает новый этап. У каждого свой опыт, свои задачи и свой взгляд на рынок.",
  "about.f3.t": "ЧТО ДАЁТ",
  "about.f3.h": "Совпадение кода.",
  "about.f3.b": "Самые ценные знакомства — те, где совпадает код: отношение к делу, способ принимать решения, темп и взгляд на развитие бизнеса. Такие офлайн встречи становятся началом новых идей, партнерств и совместных проектов.",
  "about.f4.t": "ДЕЛОВАЯ ПРОГРАММА",
  "about.f4.h": "Разговоры на одном языке.",
  "about.f4.b": "ALPS CONNECT, открытые дискуссии и Expert Tables — это разговор о реальных задачах бизнеса в Европе. О решениях, которые работают, ошибках, которых можно избежать, и опыте, который помогает двигаться дальше.",
...
const en: Dict = {
  ...
  "about.f1.t": "FORMAT",
  "about.f1.h": "Building a business environment.",
  "about.f1.b": "Ski Opening is five days in the Alps where leisure and business naturally complement each other. Mountains and skiing by day. A business programme, meetings and shared dinners by night. This format makes it easy to connect and read each other's code.",
  "about.f2.t": "PARTICIPANTS",
  "about.f2.h": "People just like you.",
  "about.f2.b": "Entrepreneurs, investors and experts from across Europe. Some have lived here for years, others are just starting a new chapter. Everyone brings their own experience, their own goals and their own view of the market.",
  "about.f3.t": "WHAT YOU GET",
  "about.f3.h": "A matching code.",
  "about.f3.b": "The most valuable connections are the ones where the code matches: attitude to work, the way decisions are made, pace and outlook on growing a business. These offline meetings become the start of new ideas, partnerships and joint projects.",
  "about.f4.t": "BUSINESS PROGRAM",
  "about.f4.h": "Talking in one language.",
  "about.f4.b": "ALPS CONNECT, open discussions and Expert Tables — a conversation about the real challenges of doing business in Europe. About solutions that work, mistakes you can avoid, and experience that helps you move forward.",
