    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative overflow-hidden bg-white">
        <div className="absolute inset-y-0 right-0 w-full lg:w-[62%]">
          ...
          <div className="absolute inset-0 bg-[linear-gradient(to_right,white_0%,rgba(255,255,255,0.85)_75%,rgba(255,255,255,0.2)_100%)] lg:bg-[linear-gradient(to_right,white_0%,rgba(255,255,255,0.4)_40%,transparent_70%)]" />
        </div>
